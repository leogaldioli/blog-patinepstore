...
import { supabase, CATEGORY_LABELS_EN } from "@/lib/supabase";

export const alt = "Patinep Store — article about electric scooters";
...
export default async function Image({ params }: Props) {
  ...
  const category =
    (post?.category && CATEGORY_LABELS_EN[post.category]) || "Patinep Store";
